...
namespace Evaluant.Uss.SqlMapper.Mapping
{
	...
	/// </summary>
	internal partial class SqlMapperMappingDocView : SqlMapperMappingDocViewBase
	{
		/// <summary>
		/// Constructs a new SqlMapperMappingDocView.
		/// </summary>
		public SqlMapperMappingDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class SqlMapperMappingDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new SqlMapperMappingDocView.
		/// </summary>
		...
		protected override bool LoadView()
		{
			...
			SqlMapperMappingDocDataBase docData = this.DocData as SqlMapperMappingDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for SqlMapperMappingDocViewBase should be an SqlMapperMappingDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.SqlMapperMappingDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);

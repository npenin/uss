...
namespace Evaluant.Uss.SqlMapper.Mapping
{
	...
	/// </summary>
	internal partial class SqlMapperMappingDocData : SqlMapperMappingDocDataBase
	{
		/// <summary>
		/// Constructs a new SqlMapperMappingDocData.
		/// </summary>
		public SqlMapperMappingDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a SqlMapperMapping document in memory.
	/// </summary>
	internal abstract partial class SqlMapperMappingDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new SqlMapperMappingDocDataBase.
		/// </summary>
		protected SqlMapperMappingDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Evaluant.Uss.SqlMapper.Mapping.Mapping modelRoot = null;
			...
			global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Evaluant.Uss.SqlMapper.Mapping.Mapping modelRoot = (global::Evaluant.Uss.SqlMapper.Mapping.Mapping)this.RootElement;
			...
			{
				global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagram diagram = diagrams[0] as global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Evaluant.Uss.SqlMapper.Mapping.Mapping modelRoot = this.RootElement as global::Evaluant.Uss.SqlMapper.Mapping.Mapping;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}

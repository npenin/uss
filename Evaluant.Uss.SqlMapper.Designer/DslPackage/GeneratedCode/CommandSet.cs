...
namespace Evaluant.Uss.SqlMapper.Mapping
{
	...
	/// </summary>
	internal partial class SqlMapperMappingCommandSet : SqlMapperMappingCommandSetBase
	{
		/// <summary>
		/// Constructs a new SqlMapperMappingCommandSet.
		/// </summary>
		public SqlMapperMappingCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class SqlMapperMappingCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new SqlMapperMappingCommandSetBase.
		/// </summary>
		protected SqlMapperMappingCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewSqlMapperMappingExplorerCommand,
				typeof(SqlMapperMappingEditorFactory).GUID);
		...
		{
			SqlMapperMappingExplorerToolWindow explorer = this.SqlMapperMappingExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected SqlMapperMappingDocData CurrentSqlMapperMappingDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as SqlMapperMappingDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected SqlMapperMappingDocView CurrentSqlMapperMappingDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as SqlMapperMappingDocView;
			}
		}
		...
		/// </summary>
		protected SqlMapperMappingExplorerToolWindow SqlMapperMappingExplorerToolWindow
		{
			get
			{
				SqlMapperMappingExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(SqlMapperMappingExplorerToolWindow), true) as SqlMapperMappingExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				SqlMapperMappingExplorerToolWindow explorerWindow = this.SqlMapperMappingExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class SqlMapperMappingClipboardCommandSet : SqlMapperMappingClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new SqlMapperMappingClipboardCommandSet.
		/// </summary>
		public SqlMapperMappingClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class SqlMapperMappingClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new SqlMapperMappingClipboardCommandSetBase.
		/// </summary>
		protected SqlMapperMappingClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}

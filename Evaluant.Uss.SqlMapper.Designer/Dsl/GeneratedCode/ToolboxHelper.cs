...
namespace Evaluant.Uss.SqlMapper.Mapping
{
	...
	/// </remarks>
	public partial class SqlMapperMappingToolboxHelper : SqlMapperMappingToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new SqlMapperMappingToolboxHelper.
		/// </summary>
		public SqlMapperMappingToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class SqlMapperMappingToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify SqlMapperMapping toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "SqlMapperMapping.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new SqlMapperMappingToolboxHelperBase.
		/// </summary>
		protected SqlMapperMappingToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDomainModel.SingletonResourceManager.GetString("SqlMapperMappingToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDomainModel));

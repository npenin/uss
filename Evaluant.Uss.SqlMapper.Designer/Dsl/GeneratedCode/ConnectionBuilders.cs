...
namespace Evaluant.Uss.SqlMapper.Mapping
{
	...
	/// </summary>
	public static partial class SqlMapperMappingDiagramReferencesEntityShapesBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagram)
			{ 
				return true;
			}
			else
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::Evaluant.Uss.SqlMapper.Mapping.EntityShape)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagram)
				{
					if (candidateTarget is global::Evaluant.Uss.SqlMapper.Mapping.EntityShape)
					{
						global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagram sourceSqlMapperMappingDiagram = (global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagram)candidateSource;
						global::Evaluant.Uss.SqlMapper.Mapping.EntityShape targetEntityShape = (global::Evaluant.Uss.SqlMapper.Mapping.EntityShape)candidateTarget;
						if(targetEntityShape == null || sourceSqlMapperMappingDiagram == null || global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagramReferencesEntityShapes.GetLinks(sourceSqlMapperMappingDiagram, targetEntityShape).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagram)
				{
					if (target is global::Evaluant.Uss.SqlMapper.Mapping.EntityShape)
					{
						global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagram sourceAccepted = (global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagram)source;
						global::Evaluant.Uss.SqlMapper.Mapping.EntityShape targetAccepted = (global::Evaluant.Uss.SqlMapper.Mapping.EntityShape)target;
						DslModeling::ElementLink result = new global::Evaluant.Uss.SqlMapper.Mapping.SqlMapperMappingDiagramReferencesEntityShapes(sourceAccepted, targetAccepted);
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class EntityShapeReferencesRelationshipshapeBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::Evaluant.Uss.SqlMapper.Mapping.Relationshipshape)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Evaluant.Uss.SqlMapper.Mapping.EntityShape)
				{
					if (candidateTarget is global::Evaluant.Uss.SqlMapper.Mapping.Relationshipshape)
					{
						global::Evaluant.Uss.SqlMapper.Mapping.EntityShape sourceEntityShape = (global::Evaluant.Uss.SqlMapper.Mapping.EntityShape)candidateSource;
						global::Evaluant.Uss.SqlMapper.Mapping.Relationshipshape targetRelationshipshape = (global::Evaluant.Uss.SqlMapper.Mapping.Relationshipshape)candidateTarget;
						if(targetRelationshipshape == null || sourceEntityShape == null || global::Evaluant.Uss.SqlMapper.Mapping.EntityShapeReferencesRelationshipshape.GetLinks(sourceEntityShape, targetRelationshipshape).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Evaluant.Uss.SqlMapper.Mapping.EntityShape)
				{
					if (target is global::Evaluant.Uss.SqlMapper.Mapping.Relationshipshape)
					{
						global::Evaluant.Uss.SqlMapper.Mapping.EntityShape sourceAccepted = (global::Evaluant.Uss.SqlMapper.Mapping.EntityShape)source;
						global::Evaluant.Uss.SqlMapper.Mapping.Relationshipshape targetAccepted = (global::Evaluant.Uss.SqlMapper.Mapping.Relationshipshape)target;
						DslModeling::ElementLink result = new global::Evaluant.Uss.SqlMapper.Mapping.EntityShapeReferencesRelationshipshape(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	internal partial class ExampleRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		...
		private partial class ExampleRelationshipConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder EntityShapeReferencesRelationshipshapeBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return EntityShapeReferencesRelationshipshapeBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return EntityShapeReferencesRelationshipshapeBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				EntityShapeReferencesRelationshipshapeBuilder.Connect(sourceElement, targetElement);
			}
		}

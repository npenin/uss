...
namespace Evaluant.Uss.SqlMapper.Mapping
{
	...
	/// </remarks>
	public partial class SqlMapperMappingHelpKeywordHelper : SqlMapperMappingHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new SqlMapperMappingHelpKeywordHelper.
		/// </summary>
		protected SqlMapperMappingHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the SqlMapperMappingHelpKeywordHelper.
		/// </summary>
		public static SqlMapperMappingHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class SqlMapperMappingHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new SqlMapperMappingHelpKeywordHelperBase.
		/// </summary>
		protected SqlMapperMappingHelpKeywordHelperBase()
			: base() { }
